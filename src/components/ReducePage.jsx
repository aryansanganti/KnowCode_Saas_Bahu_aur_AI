    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#EFE3C2] to-[#85A947] p-4 sm:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <Leaf className="mr-4 h-10 w-10 text-[#3E7B27]" />
            Reduce Tips
          </motion.h1>
              ...
              >
                ...
                >
                  <div className="flex items-center">
                    ...
                    <h2 className="text-xl font-semibold text-[#3E7B27]">{tip.title}</h2>
                  </div>
                  {expandedTip === index ? (
                ...
                <AnimatePresence>
                  {expandedTip === index && (
                    <motion.div
                      ...
                      className="px-4 pb-4"
                    >
                      <p className="text-[#123524] leading-relaxed">{tip.text}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </motion.div>
