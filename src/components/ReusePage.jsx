    ...
    <>
     ...
     <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 p-4 sm:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <Recycle className="mr-4 h-10 w-10 text-teal-600" />
        ...
        >
          <input
            ...
            className="w-full p-4 pl-12 pr-4 text-gray-700 bg-white bg-opacity-80 border-2 border-green-300 rounded-full shadow-lg focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent"
            value={searchQuery}
            ...
            >
              ...
              >
                <div className="flex items-center">
                  ...
                  <h2 className="text-xl font-semibold text-green-700">{idea.title}</h2>
                </div>
                {expandedIdea === index ? (
